...
public class Admin {
    ...
    public void add_customer(String name, String national_id, String password, int initial_money) {
        new Customer(name, national_id, password, initial_money);
    }
    ...
    public void add_account(Customer owner) {owner.create_a_account();}
